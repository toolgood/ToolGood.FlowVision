...
namespace ToolGood.Algorithm2.Internals
{
    internal sealed class MathVisitor : AbstractParseTreeVisitor<Operand>, ImathVisitor<Operand>
    {
...
#endif
            return Operand.Create(random.NextDouble());
        }
        ...
        public Operand VisitRANDBETWEEN_fun(mathParser.RANDBETWEEN_funContext context)
        {
            ...
            var random = Random.Shared;
#endif
            return Operand.Create((decimal)random.NextDouble() * (args2.NumberValue - args1.NumberValue) + args1.NumberValue);
        }
        ...
        private string F_base_ToChineseRMB(decimal x)
        {
        ...
        public Operand VisitADDMONTHS_fun(mathParser.ADDMONTHS_funContext context)
        {
        ...
        public Operand VisitADDYEARS_fun(mathParser.ADDYEARS_funContext context)
        {
            var args = new List<Operand>();
            foreach (var item in context.expr()) { var aa = item.Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
        ...
        public Operand VisitADDSECONDS_fun(mathParser.ADDSECONDS_funContext context)
        {
            var args = new List<Operand>();
            foreach (var item in context.expr()) { var aa = item.Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
        ...
        public Operand VisitADDMINUTES_fun(mathParser.ADDMINUTES_funContext context)
        {
            var args = new List<Operand>();
            foreach (var item in context.expr()) { var aa = item.Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
        ...
        public Operand VisitADDDAYS_fun(mathParser.ADDDAYS_funContext context)
        {
            var args = new List<Operand>();
            foreach (var item in context.expr()) { var aa = item.Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
        ...
        public Operand VisitADDHOURS_fun(mathParser.ADDHOURS_funContext context)
        {
            var args = new List<Operand>();
            foreach (var item in context.expr()) { var aa = item.Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
        ...
        private int F_base_countif(List<decimal> dbs, decimal d)
        {
            int count = 0;
        ...
        private int F_base_countif(List<decimal> dbs, string s, decimal d)
        {
            int count = 0;
            for (int i = 0; i < dbs.Count; i++) {
                var item = dbs[i];
        ...
        private decimal F_base_sumif(List<decimal> dbs, decimal d, List<decimal> sumdbs)
        {
            decimal sum = 0;
            for (int i = 0; i < dbs.Count; i++) {
                var item = dbs[i];
        ...
        private decimal F_base_sumif(List<decimal> dbs, string s, decimal d, List<decimal> sumdbs)
        {
            decimal sum = 0;
            for (int i = 0; i < dbs.Count; i++) {

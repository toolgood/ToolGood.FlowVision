...
namespace ToolGood.JsonObject
{
	public abstract partial class JToken : IJEnumerable<JToken>, IJsonLineInfo
	{
		...
		/// <summary>
		/// Performs an explicit conversion from <see cref="JToken"/> to <see cref="bool"/>.
		/// </summary>
		/// <param name="value">The value.</param>
		...
		/// <summary>
		/// Performs an explicit conversion from <see cref="JToken"/> to <see cref="sbyte"/>.
		/// </summary>
		/// <param name="value">The value.</param>
		/// <returns>The result of the conversion.</returns>
		////[CLSCompliant(false)]
		...
		/// <summary>
		/// Performs an explicit conversion from <see cref="JToken"/> to <see cref="ulong"/>.
		/// </summary>
		/// <param name="value">The value.</param>
		/// <returns>The result of the conversion.</returns>
		////[CLSCompliant(false)]

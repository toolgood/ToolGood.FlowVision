...
namespace ToolGood.JsonObject.Commens
{
	...
	public partial class JsonTextWriter : JsonWriter
	{
		...
		/// <summary>
		/// Gets or sets how many <see cref="IndentChar"/>s to write for each level in the hierarchy when <see cref="JsonWriter.Formatting"/> is set to <see cref="Formatting.Indented"/>.
		/// </summary>

...
namespace ToolGood.JsonObject.Commens
{
	...
	public partial class JsonTextReader : JsonReader, IJsonLineInfo
	{
		...
		/// </summary>
		/// <value>
		/// The current line number or 0 if no line information is available (for example, <see cref="HasLineInfo"/> returns <c>false</c>).
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The current line position or 0 if no line information is available (for example, <see cref="HasLineInfo"/> returns <c>false</c>).
		/// </value>

        ...
        var MyHighlightRules = function () {
            this.$rules = {
                "start": [
                    ...
                    { token: "string", regex: "[Uu][Rr][Ll][Ee][Nn][Cc][Oo][Dd][Ee]\\b|[Uu][Rr][Ll][Dd][Ee][Cc][Oo][Dd][Ee]\\b|[Hh][Tt][Mm][Ll][Ee][Nn][Cc][Oo][Dd][Ee]\\b|[Hh][Tt][Mm][Ll][Dd][Ee][Cc][Oo][Dd][Ee]\\b|[Bb][Aa][Ss][Ee]64[Tt][Oo][Tt][Ee][Xx][Tt]\\b|[Bb][Aa][Ss][Ee]64[Uu][Rr][Ll][Tt][Oo][Tt][Ee][Xx][Tt]\\b|[Tt][Ee][Xx][Tt][Tt][Oo][Bb][Aa][Ss][Ee]64\\b|[Tt][Ee][Xx][Tt][Tt][Oo][Bb][Aa][Ss][Ee]64[Uu][Rr][Ll]\\b|[Rr][Ee][Gg][Ee][Xx]\\b|[Rr][Ee][Gg][Ee][Xx][Rr][Ee][Pp][Aa][Ll][Cc][Ee]\\b|[Gg][Uu][Ii][Dd]\\b|[Mm][Dd]5\\b|[Ss][Hh][Aa]1\\b|[Ss][Hh][Aa]256\\b|[Ss][Hh][Aa]512\\b|[Cc][Rr][Cc]32\\b|[Hh][Mm][Aa][Cc][Mm][Dd]5\\b|[Hh][Mm][Aa][Cc][Ss][Hh][Aa]1\\b|[Hh][Mm][Aa][Cc][Ss][Hh][Aa]256\\b|[Hh][Mm][Aa][Cc][Ss][Hh][Aa]512\\b|[Tt][Rr][Ii][Mm][Ss][Tt][Aa][Rr][Tt]\\b|[Ll][Tt][Rr][Ii][Mm]\\b|[Tt][Rr][Ii][Mm][Ee][Nn][Dd]\\b|[Rr][Tt][Rr][Ii][Mm]\\b|[Ii][Nn][Dd][Ee][Xx][Oo][Ff]\\b|[Ll][Aa][Ss][Tt][Ii][Nn][Dd][Ee][Xx][Oo][Ff]\\b|[Ss][Pp][Ll][Ii][Tt]\\b|[Jj][Oo][Ii][Nn]\\b|[Ss][Uu][Bb][Ss][Tt][Rr][Ii][Nn][Gg]\\b|[Ss][Tt][Aa][Rr][Tt][Ss][Ww][Ii][Tt][Hh]\\b|[Ee][Nn][Dd][Ss][Ww][Ii][Tt][Hh]\\b|[Rr][Ee][Mm][Oo][Vv][Ee][Ss][Tt][Aa][Rr][Tt]\\b|[Rr][Ee][Mm][Oo][Vv][Ee][Ee][Nn][Dd]\\b|[Jj][Ss][Oo][Nn]\\b|[Vv][Ll][Oo][Oo][Kk][Uu][Pp]\\b|[Ll][Oo][Oo][Kk][Uu][Pp]\\b" },

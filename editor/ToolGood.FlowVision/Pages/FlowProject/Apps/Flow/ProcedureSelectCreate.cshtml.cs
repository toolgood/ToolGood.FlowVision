...
namespace ToolGood.FlowVision.Pages.FlowProject.Apps.Flow
{
	...
	public class ProcedureSelectCreateModel : MemberPageModel
	{
		private readonly IMemberApplication _application;
		private readonly IMemberFlowApplication _memberFlowApplication;

		public ProcedureSelectCreateModel(IMemberApplication MemberApplication, IMemberFlowApplication memberFlowApplication)
		{

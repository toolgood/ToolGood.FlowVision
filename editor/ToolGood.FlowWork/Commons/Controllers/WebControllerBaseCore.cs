...
namespace ToolGood.FlowWork.Commons.Controllers
{
	public abstract class WebControllerBaseCore : Controller
	{
		...
		//{
		//    HttpContextHelper.BuildQueryArgs(context.HttpContext, context.ActionArguments);
		...
		protected IActionResult Success(object obj, List<string> status)
		{
			return ActionResultUtil.Success(obj, status);
		}
		...
		{
			return ToSafeString(Request.Headers["User-Agent"]);
		}

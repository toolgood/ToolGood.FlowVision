...
public class AlgorithmEngineTest_vlookup {
    ...
    public void vlookup_test()
    {
        ...
        int num = engine.TryEvaluate("vlookup(array(array(1,2,3),array(2,3,4),array(3,4,5),array(4,5,6)),3,2)", 0);
        assertEquals(num, 4);
    ...
    public void lookup_test()
    {
        ...
        String num = engine.TryEvaluate("lookup([jsonArray].Json(),'[saleCount]=91','specId')", "");
        assertEquals(num, "43b0e72e98731aed69e1f0cc7d64bf4d");

        num = engine.TryEvaluate("lookup([jsonArray].Json(),'[saleCount]=35','specId')", "");
        assertEquals(num, "e959b6ab7c355e403a3312c75bd3d5b4");

        num = engine.TryEvaluate("lookup([jsonArray].Json(),'[蓝色]=\"L\"','specId')", "");
        assertEquals(num, "e959b6ab7c355e403a3312c75bd3d5b4");

...
public class NumberUnitTypeHelper {
      ...
      static Map<String, NumberUnitType> GetUnitTypedict()
    {
     ...
     public static double TransformationUnit(double src, NumberUnitType type1, DistanceUnitType distance, AreaUnitType area, VolumeUnitType volume, MassUnitType mass) throws Exception {
        if (type1.getValue() == NumberUnitType.MM.getValue()) {
            switch (distance) {
                case MM: return src;
                case CM: return src * 0.1;
                case DM: return src * 0.01;
                case M: return src * 0.001;
                case KM: return src * 0.000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.CM.getValue()) {
            switch (distance) {
                case MM: return src * 10;
                case CM: return src;
                case DM: return src * 0.1;
                case M: return src * 0.01;
                case KM: return src * 0.00001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.DM.getValue()) {
            switch (distance) {
                case MM: return src * 100;
                case CM: return src * 10;
                case DM: return src;
                case M: return src * 0.1;
                case KM: return src * 0.0001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.M.getValue()) {
            switch (distance) {
                case MM: return src * 1000;
                case CM: return src * 100;
                case DM: return src * 10;
                case M: return src;
                case KM: return src * 0.001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.KM.getValue()) {
            switch (distance) {
                case MM: return src * 1000000;
                case CM: return src * 100000;
                case DM: return src * 10000;
                case M: return src * 1000;
                case KM: return src;
                default: throw new Exception("Number unit is error!");
            }
            ...
            switch (area) {
                case MM2: return src;
                case CM2: return src * 0.01;
                case DM2: return src * 0.0001;
                case M2: return  src * 0.000001;
                case KM2: return src * 0.000000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.CM2.getValue()) {
            switch (area) {
                case MM2: return src * 100;
                case CM2: return src;
                case DM2: return src * 0.01;
                case M2: return  src * 0.0001;
                case KM2: return src * 0.0000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.DM2.getValue()) {
            switch (area) {
                case MM2: return src * 10000;
                case CM2: return src * 100;
                case DM2: return src;
                case M2:  return src * 0.01;
                case KM2: return src * 0.00000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.M2.getValue()) {
            switch (area) {
                case MM2: return src * 1000000;
                case CM2: return src * 10000;
                case DM2: return src * 100;
                case M2: return src;
                case KM2: return src * 0.000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.KM2.getValue()) {
            switch (area) {
                case MM2: return src * 1000000000000d;
                case CM2: return src * 10000000000d;
                case DM2: return src * 100000000;
                case M2: return  src * 1000000;
                case KM2: return src;
                default: throw new Exception("Number unit is error!");
            }
            ...
            switch (volume) {
                case MM3: return src;
                case CM3: return src * 0.001;
                case DM3: return src * 0.000001;
                case M3:  return src * 0.000000001;
                case KM3: return src * 0.000000000000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.CM3.getValue()) {
            switch (volume) {
                case MM3: return src * 1000;
                case CM3: return src;
                case DM3: return src * 0.001;
                case M3: return  src * 0.000001;
                case KM3: return src * 0.000000000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.DM3.getValue()) {
            switch (volume) {
                case MM3: return src * 1000000;
                case CM3: return src * 1000;
                case DM3: return src;
                case M3:  return src * 0.001;
                case KM3: return src * 0.000000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.M3.getValue()) {
            switch (volume) {
                case MM3: return src * 1000000000;
                case CM3: return src * 1000000;
                case DM3: return src * 1000;
                case M3:  return src;
                case KM3: return src * 0.000000001;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.KM3.getValue()) {
            switch (volume) {
                case MM3: return src * 1000000000000000000d;
                case CM3: return src * 1000000000000000d;
                case DM3: return src * 1000000000000d;
                case M3:  return src * 1000000000;
                case KM3: return src;
                default: throw new Exception("Number unit is error!");
            }
            ...
            switch (mass) {
                case G: return src;
                case KG: return src * 1000;
                case T:  return src * 1000000;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.KG.getValue()) {
            switch (mass) {
                case G: return src * 0.001;
                case KG: return src;
                case T: return src * 1000;
                default: throw new Exception("Number unit is error!");
            }
        } else if (type1.getValue() == NumberUnitType.T.getValue()) {
            switch (mass) {
                case G:  return src * 0.000001;
                case KG: return src * 0.001;
                case T: return src;
                default: throw new Exception("Number unit is error!");
            }
        }

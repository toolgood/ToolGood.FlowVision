package toolgood.algorithm2.mathNet;
...
public class SpecialFunctions {
    ...
    private static final double[] ErfImpAn = {0.00337916709551257388990745, -0.00073695653048167948530905,
    ...
    private static final double[] ErfImpAd = {1, -0.218088218087924645390535, 0.412542972725442099083918,
    ...
    private static final double[] ErfImpBn = {-0.0361790390718262471360258, 0.292251883444882683221149,
            0.281447041797604512774415, 0.125610208862766947294894, 0.0274135028268930549240776,
            0.00250839672168065762786937};
    private static final double[] ErfImpBd = {1, 1.8545005897903486499845, 1.43575803037831418074962,
            0.582827658753036572454135, 0.124810476932949746447682, 0.0113724176546353285778481};
    private static final double[] ErfImpCn = {-0.0397876892611136856954425, 0.153165212467878293257683,
    ...
    private static final double[] ErfImpCd = {1, 1.95520072987627704987886, 1.64762317199384860109595,
            0.768238607022126250082483, 0.209793185936509782784315, 0.0319569316899913392596356,
            0.00213363160895785378615014};
    private static final double[] ErfImpDn = {-0.0300838560557949717328341, 0.0538578829844454508530552,
    ...
    private static final double[] ErfImpDd = {1, 1.75967098147167528287343, 1.32883571437961120556307,
    ...
    private static final double[] ErfImpEn = {-0.0117907570137227847827732, 0.014262132090538809896674,
    ...
    private static final double[] ErfImpEd = {1, 1.50376225203620482047419, 0.965397786204462896346934,
            0.339265230476796681555511, 0.0689740649541569716897427, 0.00771060262491768307365526,
            0.000371421101531069302990367};
    private static final double[] ErfImpFn = {-0.00546954795538729307482955, 0.00404190278731707110245394,
    ...
    private static final double[] ErfImpFd = {1, 1.21019697773630784832251, 0.620914668221143886601045,
    ...
    private static final double[] ErfImpGn = {-0.00270722535905778347999196, 0.0013187563425029400461378,
            0.00119925933261002333923989, 0.00027849619811344664248235, 0.267822988218331849989363e-4,
            0.923043672315028197865066e-6};
    private static final double[] ErfImpGd = {1, 0.814632808543141591118279, 0.268901665856299542168425,
            0.0449877216103041118694989, 0.00381759663320248459168994, 0.000131571897888596914350697,
            0.404815359675764138445257e-11};
    private static final double[] ErfImpHn = {-0.00109946720691742196814323, 0.000406425442750422675169153,
            0.000274499489416900707787024, 0.465293770646659383436343e-4, 0.320955425395767463401993e-5,
            0.778286018145020892261936e-7};
    private static final double[] ErfImpHd = {1, 0.588173710611846046373373, 0.139363331289409746077541,
            0.0166329340417083678763028, 0.00100023921310234908642639, 0.24254837521587225125068e-4};
    private static final double[] ErfImpIn = {-0.00056907993601094962855594, 0.000169498540373762264416984,
            0.518472354581100890120501e-4, 0.382819312231928859704678e-5, 0.824989931281894431781794e-7};
    private static final double[] ErfImpId = {1, 0.339637250051139347430323, 0.043472647870310663055044,
            0.00248549335224637114641629, 0.535633305337152900549536e-4, -0.117490944405459578783846e-12};
    private static final double[] ErfImpJn = {-0.000241313599483991337479091, 0.574224975202501512365975e-4,
            0.115998962927383778460557e-4, 0.581762134402593739370875e-6, 0.853971555085673614607418e-8};
    private static final double[] ErfImpJd = {1, 0.233044138299687841018015, 0.0204186940546440312625597,
            0.000797185647564398289151125, 0.117019281670172327758019e-4};
    private static final double[] ErfImpKn = {-0.000146674699277760365803642, 0.162666552112280519955647e-4,
            0.269116248509165239294897e-5, 0.979584479468091935086972e-7, 0.101994647625723465722285e-8};
    private static final double[] ErfImpKd = {1, 0.165907812944847226546036, 0.0103361716191505884359634,
            0.000286593026373868366935721, 0.298401570840900340874568e-5};
    private static final double[] ErfImpLn = {-0.583905797629771786720406e-4, 0.412510325105496173512992e-5,
            0.431790922420250949096906e-6, 0.993365155590013193345569e-8, 0.653480510020104699270084e-10};
    private static final double[] ErfImpLd = {1, 0.105077086072039915406159, 0.00414278428675475620830226,
            0.726338754644523769144108e-4, 0.477818471047398785369849e-6};
    private static final double[] ErfImpMn = {-0.196457797609229579459841e-4, 0.157243887666800692441195e-5,
            0.543902511192700878690335e-7, 0.317472492369117710852685e-9};
    private static final double[] ErfImpMd = {1, 0.052803989240957632204885, 0.000926876069151753290378112,
            0.541011723226630257077328e-5, 0.535093845803642394908747e-15};
    private static final double[] ErfImpNn = {-0.789224703978722689089794e-5, 0.622088451660986955124162e-6,
            0.145728445676882396797184e-7, 0.603715505542715364529243e-10};
    private static final double[] ErfImpNd = {1, 0.0375328846356293715248719, 0.000467919535974625308126054,
            0.193847039275845656900547e-5};
    private static final double[] ErvInvImpAn = {-0.000508781949658280665617, -0.00836874819741736770379,
    ...
    private static final double[] ErvInvImpAd = {1, -0.970005043303290640362, -1.56574558234175846809,
    ...
    private static final double[] ErvInvImpBn = {-0.202433508355938759655, 0.105264680699391713268, 8.37050328343119927838,
    ...
    private static final double[] ErvInvImpBd = {1, 6.24264124854247537712, 3.9713437953343869095, -28.6608180499800029974,
            -20.1432634680485188801, 48.5609213108739935468, 10.8268667355460159008, -22.6436933413139721736,
            1.72114765761200282724};
    private static final double[] ErvInvImpCn = {-0.131102781679951906451, -0.163794047193317060787, 0.117030156341995252019,
    ...
    private static final double[] ErvInvImpCd = {1, 3.46625407242567245975, 5.38168345707006855425, 4.77846592945843778382,
            2.59301921623620271374, 0.848854343457902036425, 0.152264338295331783612, 0.01105924229346489121};
    private static final double[] ErvInvImpDn = {-0.0350353787183177984712, -0.00222426529213447927281,
    ...
    private static final double[] ErvInvImpDd = {1, 1.3653349817554063097, 0.762059164553623404043, 0.220091105764131249824,
            0.0341589143670947727934, 0.00263861676657015992959, 0.764675292302794483503e-4};
    private static final double[] ErvInvImpEn = {-0.0167431005076633737133, -0.00112951438745580278863,
    ...
    private static final double[] ErvInvImpEd = {1, 0.591429344886417493481, 0.138151865749083321638,
            0.0160746087093676504695, 0.000964011807005165528527, 0.275335474764726041141e-4,
            0.282243172016108031869e-6};
    private static final double[] ErvInvImpFn = {-0.0024978212791898131227, -0.779190719229053954292e-5,
    ...
    private static final double[] ErvInvImpFd = {1, 0.207123112214422517181, 0.0169410838120975906478,
            0.000690538265622684595676, 0.145007359818232637924e-4, 0.144437756628144157666e-6,
            0.509761276599778486139e-9};
    private static final double[] ErvInvImpGn = {-0.000539042911019078575891, -0.28398759004727721098e-6,
    ...
    private static final double[] ErvInvImpGd = {1, 0.0845746234001899436914, 0.00282092984726264681981,

...
import toolgood.algorithm2.Enums.*;
import toolgood.algorithm2.MyDate;
import toolgood.algorithm2.Operand;
import toolgood.algorithm2.litJson.JsonData;
import toolgood.algorithm2.litJson.JsonMapper;
import toolgood.algorithm2.math.mathParser.*;
import toolgood.algorithm2.math.mathVisitor;
...
public class MathVisitor extends AbstractParseTreeVisitor<Operand> implements mathVisitor<Operand> {
    ...
    public Operand visitACOSH_fun(final ACOSH_funContext context) {
        ...
        final double r = Math.log(z.doubleValue() + Math.pow(z.doubleValue() * z.doubleValue() - 1, 0.5));
        return Operand.Create(r);
    }
    ...
    public Operand visitROUND_fun(final ROUND_funContext context) {
        ...
        final Operand secondValue = args.get(1);
        return Operand.Create(round(firstValue.NumberValue().doubleValue(), secondValue.IntValue()));
    }
    ...
    public Operand visitCEILING_fun(final CEILING_funContext context) {
        ...
        final double d = Math.ceil(a / b.doubleValue()) * b.doubleValue();
        return Operand.Create(d);
    }
    ...
    public Operand visitCODE_fun(final CODE_funContext context) {
        ...
        return Operand.Create((double) (int) t.charAt(0));
    }
    ...
    public Operand visitDATEDIF_fun(final DATEDIF_funContext context) {
        ...
        if (CharUtil.Equals(t, "y")) {
            ...
            boolean b = startDate.Day <= endDate.Day;
            if (b) {
    ...
    public Operand visitINDEXOF_fun(final INDEXOF_funContext context) {
        ...
        if (args.size() == 3) {
            return Operand.Create(text.substring(thirdValue.IntValue()).indexOf(secondValue.TextValue())
    ...
    public Operand visitLASTINDEXOF_fun(final LASTINDEXOF_funContext context) {
        ...
        if (args.size() == 3) {
            return Operand
                    .Create(text.substring(thirdValue.IntValue()).lastIndexOf(secondValue.TextValue())
                            + thirdValue.IntValue() + excelIndex);
        }
        ...
        return Operand.Create(text.substring(thirdValue.IntValue()).lastIndexOf(secondValue.TextValue(),
                fourthValue.IntValue()) + thirdValue.IntValue() + excelIndex);
    }
    ...
    public Operand visitISNULLORWHITESPACE_fun(final ISNULLORWHITESPACE_funContext context) {
        ...
        boolean b = firstValue.TextValue() == null || firstValue.TextValue().trim().equals("");
        return Operand.Create(b);
    }

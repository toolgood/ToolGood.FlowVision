package toolgood.algorithm2.math;// Generated from java-escape by ANTLR 4.11.1
...
public interface mathVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by the {@code IN_fun}
     * labeled alternative in {@link mathParser#expr}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitIN_fun(mathParser.IN_funContext ctx);

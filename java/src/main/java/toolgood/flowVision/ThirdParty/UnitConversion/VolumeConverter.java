...
public class VolumeConverter extends BaseUnitConverter {
    ...
    static {
        ...
        units.put(new UnitFactorSynonyms(new String[]{"l", "L", "lt", "ltr", "liter", "litre", "dm³", "dm3", "cubic decimetre", "升", "立方分米"}), new BigDecimal("1"));
        units.put(new UnitFactorSynonyms(new String[]{"m³", "m3", "cubic metre", "立方米"}), new BigDecimal("0.001"));
        units.put(new UnitFactorSynonyms(new String[]{"cm³", "cm3", "cubic centimetre", "立方厘米", "毫升"}), new BigDecimal("1000"));
        units.put(new UnitFactorSynonyms(new String[]{"mm³", "mm3", "cubic millimetre", "立方毫米"}), new BigDecimal("1000000"));

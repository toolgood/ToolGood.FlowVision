...
using ToolGood.Algorithm2.MathNet.Numerics;

namespace ToolGood.Algorithm2.Internals
{
	internal sealed class MathVisitor : AbstractParseTreeVisitor<Operand>, ImathVisitor<Operand>
	{
		...
		{
			var args1 = context.expr().Accept(this); if (args1.IsError) { return args1; }
		...
		public Operand VisitAND_fun(mathParser.AND_funContext context)
		{
			...
			for (int i = 0; i < exprs.Length; i++) {
				var a = exprs[i].Accept(this); if (a.Type != OperandType.BOOLEAN) { a = a.ToBoolean($"Function AND parameter {index++} is error!"); if (a.IsError) { return a; } }
		...
		public Operand VisitOR_fun(mathParser.OR_funContext context)
		{
			...
			var exprs = context.expr();
			for (int i = 0; i < exprs.Length; i++) {
				var a = exprs[i].Accept(this); if (a.Type != OperandType.BOOLEAN) { a = a.ToBoolean($"Function OR parameter {index++} is error!"); if (a.IsError) { return a; } }
		...
		{
			var args1 = context.expr().Accept(this); if (args1.Type != OperandType.BOOLEAN) { args1 = args1.ToBoolean("Function NOT parameter is error!"); if (args1.IsError) { return args1; } }
		...
		public Operand VisitGCD_fun(mathParser.GCD_funContext context)
		{
			...
			for (int i = 0; i < exprs.Length; i++) { var aa = exprs[i].Accept(this); if (aa.IsError) { return aa; } args.Add(aa); }
		...
		{
			var args1 = context.expr().Accept(this); if (args1.Type != OperandType.NUMBER) { args1 = args1.ToNumber("Function ACOSH parameter is error!"); if (args1.IsError) { return args1; } }
		...
		{
			var exprs = context.expr();
			var args1 = exprs[0].Accept(this); if (args1.Type != OperandType.NUMBER) { args1 = args1.ToNumber("Function RANDBETWEEN parameter 1 is error!"); if (args1.IsError) { return args1; } }
			var args2 = exprs[1].Accept(this); if (args2.Type != OperandType.NUMBER) { args2 = args2.ToNumber("Function RANDBETWEEN parameter 2 is error!"); if (args2.IsError) { return args2; } }
		...
		{
			var args1 = context.expr().Accept(this); if (args1.Type != OperandType.NUMBER) { args1 = args1.ToNumber("Function FACT parameter is error!"); if (args1.IsError) { return args1; } }
		...
		public Operand VisitCONCATENATE_fun(mathParser.CONCATENATE_funContext context)
		{
			...
			for (int i = 0; i < exprs.Length; i++) {
				var a = exprs[i].Accept(this); if (a.Type != OperandType.TEXT) { a = a.ToText($"Function CONCATENATE parameter {i + 1} is error!"); if (a.IsError) { return a; } }
		...
		{
			var exprs = context.expr();
			var args1 = exprs[0].Accept(this); if (args1.Type != OperandType.NUMBER) { args1 = args1.ToNumber("Function EXACT parameter 1 is error!"); if (args1.IsError) { return args1; } }
			var args2 = exprs[1].Accept(this); if (args2.Type != OperandType.NUMBER) { args2 = args2.ToNumber("Function EXACT parameter 2 is error!"); if (args2.IsError) { return args2; } }
		...
		{
			var args1 = context.expr().Accept(this); if (args1.Type != OperandType.TEXT) { args1 = args1.ToText("Function DATEVALUE parameter is error!"); if (args1.IsError) { return args1; } }
		...
		{
			var exprs = context.expr();
			var args1 = exprs[0].Accept(this); if (args1.Type != OperandType.DATE) { args1 = args1.ToMyDate("Function EOMONTH parameter 1 is error!"); if (args1.IsError) { return args1; } }
			var args2 = exprs[1].Accept(this); if (args2.Type != OperandType.NUMBER) { args2 = args2.ToNumber("Function EOMONTH parameter 2 is error!"); if (args2.IsError) { return args2; } }
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var a = exprs[i].Accept(this); if (a.Type != OperandType.DATE) { a = a.ToMyDate($"Function NETWORKDAYS parameter {i + 1} is error!"); if (a.IsError) { return a; } } args.Add(a); }
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function MAX parameter {i + 1} is error!"); if (aa.IsError) { return aa; } } args.Add(aa); }
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function MEDIAN parameter {i + 1} is error!"); if (aa.IsError) { return aa; } } args.Add(aa); }
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function MIN parameter {i + 1} is error!"); if (aa.IsError) { return aa; } } args.Add(aa); }
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function MODE parameter {i + 1} is error!"); if (aa.IsError) { return aa; } } args.Add(aa); }
		...
		public Operand VisitPERCENTRANK_fun(mathParser.PERCENTRANK_funContext context)
		{
			...
			var d = 3;
			if (args.Count == 3) {
				var args3 = exprs[2].Accept(this); if (args3.Type != OperandType.NUMBER) { args3 = args3.ToNumber("Function PERCENTRANK parameter 3 is error!"); if (args3.IsError) { return args3; } }
				d = args3.IntValue;
			}
		...
		public Operand VisitSUM_fun(mathParser.SUM_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function SUM parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitAVEDEV_fun(mathParser.AVEDEV_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function AVEDEV parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitSTDEV_fun(mathParser.STDEV_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function STDEV parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitSTDEVP_fun(mathParser.STDEVP_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function STDEVP parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitDEVSQ_fun(mathParser.DEVSQ_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function DEVSQ parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitVAR_fun(mathParser.VAR_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function VAR parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		public Operand VisitVARP_fun(mathParser.VARP_funContext context)
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) {
				var aa = exprs[i].Accept(this); if (aa.Type != OperandType.NUMBER) { aa = aa.ToNumber($"Function VARP parameter {i + 1} error!"); if (aa.IsError) { return aa; } }
				args.Add(aa);
			}
		...
		{
			var exprs = context.expr(); var args = new List<Operand>(exprs.Length);
			for (int i = 0; i < exprs.Length; i++) { var a = exprs[i].Accept(this); if (a.Type != OperandType.TEXT) { a = a.ToText($"Function SPLIT parameter {i + 1} is error!"); if (a.IsError) { return a; } } args.Add(a); }
		...
		public Operand VisitLOOKUP_fun(mathParser.LOOKUP_funContext context)
		{
			...
			if (args1.Type == OperandType.ARRARYJSON) {
				...
				var range = false;
				if (exprs.Length == 3) {
					var t = exprs[2].Accept(this).ToBoolean("Function LOOKUP parameter 3 is error!"); if (t.IsError) { return t; }
			...
			var args3 = exprs[2].Accept(this); if (args3.Type != OperandType.TEXT) { args3 = args3.ToText("Function LOOKUP parameter 3 is error!"); if (args3.IsError) { return args3; } }
		...
		public Operand VisitPARAMETER_fun(mathParser.PARAMETER_funContext context)
		{
			...
			if (context.expr() != null) {
				var p = context.expr().Accept(this); if (p.Type != OperandType.TEXT) { p = p.ToText("Function PARAMETER first parameter is error!"); if (p.IsError) return p; }
		...
		{
			var args1 = context.expr().Accept(this); if (args1.Type != OperandType.TEXT) { args1 = args1.ToText("Function JSON parameter is error!"); if (args1.IsError) { return args1; } }
